...
//           <a
//             href="/"
//             className="text-3xl font-semibold tracking-tight text-purple-600 hover:text-purple-700 transition"
//           >
//             CloudShare
//           </a>
...
//               className="rounded-lg border border-purple-200 bg-purple-50 px-4 py-2 text-sm font-semibold text-purple-700 hover:bg-purple-100 hover:border-purple-300 transition focus:outline-none focus:ring-2 focus:ring-purple-600"
//             >
//               Admin Panel
//             </button>
...
//             <button
//               onClick={() => openSignIn()}
//               className="rounded-lg bg-gray-900 px-4 py-2 text-sm font-semibold text-white hover:bg-gray-800 transition focus:outline-none focus:ring-2 focus:ring-gray-900 cursor-pointer"
//             >
//               Sign in
//             </button>
//           </div>
...
//         }`}
//       >
//         <div className="bg-white border-t border-gray-100 px-6 pt-8 pb-10 space-y-4">
...
//               setOpen(false);
//             }}
//             className="block w-full rounded-lg border border-purple-200 bg-purple-50 px-4 py-3 text-center text-base font-semibold text-purple-700 hover:bg-purple-100 hover:border-purple-300 transition focus:outline-none focus:ring-2 focus:ring-purple-600"
//           >
//             Admin Panel
//           </button>
...
//               setOpen(false);
//             }}
//             className="block w-full rounded-lg bg-gray-900 px-4 py-3 text-center text-base font-semibold text-white hover:bg-gray-800 transition focus:outline-none focus:ring-2 focus:ring-gray-900"
//           >
//             Sign in
//           </button>
    ...
    <header className="sticky top-0 z-40 backdrop-blur-lg bg-slate-700 border-b border-slate-600">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex h-20 items-center justify-between">
          ...
          <a
            href="/"
            className="text-2xl md:text-3xl font-bold tracking-tight text-white hover:text-purple-400 transition"
          >
